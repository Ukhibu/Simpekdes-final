...
// Helper: Cek Kelengkapan Data
const checkCompleteness = (item) => {
    // [UPDATE] Menambah field wajib agar pengecekan lebih ketat sesuai form
...
const LPMDashboard = () => {
    ...
    const { stats, ageChartData, educationChartData, completenessList, dataForHierarchy } = useMemo(() => {
        ...
        // Proses Data untuk Tabel Kelengkapan & Statistik
        ...
        // [UPDATE] Filter HANYA yang BELUM LENGKAP untuk ditampilkan di tabel
        ...
        return {
            ...
            completenessList: incompleteList, // Hanya data yang belum lengkap
            dataForHierarchy: dataForCurrentView
        };
    }, [allData, currentUser]);

    // Handler Klik Baris Tabel -> Navigasi ke Edit
    const handleRowClick = (id) => {
        // Navigasi ke halaman data dan trigger modal edit
        navigate(`/app/lpm/data?edit=${id}`);
    };
    ...
    return (
        <div className="space-y-8 pb-10">
            {/* 1. Kartu Statistik Utama (Kelengkapan Data di Atas) */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                        <FiUsers className="text-blue-500"/> Struktur Organisasi
                    </h2>
             ...
             <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                        <FiBarChart2 className="text-indigo-500"/> Komposisi Usia
                    </h2>
                    <div className="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full text-sm font-medium">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                {completenessList.length > 10 && (
                    <div className="px-6 py-3 border-t border-gray-100 dark:border-gray-700 text-center text-xs text-gray-500">
                        Menampilkan 10 data teratas dari {completenessList.length} data yang belum lengkap.
                    </div>
                )}
            </div>
        </div>
