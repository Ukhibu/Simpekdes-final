...
const KarangTarunaPage = () => {
    ...
    // [PERBAIKAN] Menggunakan currentDesa sebagai state utama untuk filter desa
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md pb-24 transition-colors duration-300">
            ...
            {/* --- MODAL FORM --- */}
            <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={modalMode === 'edit' ? 'Edit Karang Taruna' : 'Tambah Karang Taruna'}>
                <form onSubmit={handleFormSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <InputField label="Tgl Pelantikan" name="tgl_pelantikan" type="date" value={formData.tgl_pelantikan || ''} onChange={handleFormChange} />
                        <InputField label="Masa Bakti (Thn)" name="masa_bakti" type="number" value={formData.masa_bakti || ''} onChange={handleFormChange} />
                    </div>
